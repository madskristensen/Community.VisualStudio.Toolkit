...
namespace TestExtension
{
    public class MultiInstanceWindow : BaseToolWindow<MultiInstanceWindow>
    {
        ...
        public override Task<FrameworkElement> CreateAsync(CreateToolWindowContext context)
        {
            return Task.FromResult<FrameworkElement>(new MultiInstanceWindowControl(context.ToolWindowId));
        }
